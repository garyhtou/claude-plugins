# Tools and Libraries Landscape

Reference for the `high-fidelity-web` skill: the opinionated "when to use what"
map of the animation/3D/web tooling landscape. Load in Phase 3 (pick the stack by
ambition) and Phase 4 (prototype).

- **Facts current as of:** 2026-06-19 (these move fast; re-verify bundle sizes,
  star counts, and versions before relying on a specific number).
